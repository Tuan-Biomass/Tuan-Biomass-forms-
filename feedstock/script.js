...
const CONFIG = {
  ...
  quiz: [
    ...
    { question: "Who controls traffic movements associated with loader operations on site?", options: ["The truck driver", "The transport company", "The loader operator", "The most experienced driver"], correct: 2, feedback: "The loader operator controls traffic movements associated with loader operations. Follow their directions at all times." },
    { question: "You become fatigued while attending site. What should you do?", options: ["Finish the delivery first", "Have a coffee and continue", "Stop work and seek help", "Continue if you are within your legal driving hours"], correct: 2, feedback: "If fatigued, stop work and seek help." },
    { question: "What can happen if a driver fails to follow Tuan site rules?", options: ["Nothing if no incident occurs", "They receive an automatic warning only", "Their rego may be recorded and reported, and they may be removed from site", "They can continue once the delivery is finished"], correct: 2, feedback: "Non-compliance may result in your rego being recorded and reported to your company, and removal from site." },
...
document.getElementById("completeInductionBtn").onclick = async () => {
  ...
  if (dlFiles.length) {
    ...
    if (dlAttachments.length) {
      ...
      uploadDocuments.push({ category: 'licence', document_type: 'Driver Licence', expiry_date: dlExpiry, licence_class: '', policy_number: '', coverage_amount: '', attachments: dlAttachments });
    }
  }
